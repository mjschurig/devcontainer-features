...
echo "🧪 Testing DOLFINx feature - Ubuntu 20.04 scenario..."

# Check OS version
check "Running on Ubuntu 20.04" cat /etc/os-release | grep -q "20.04"
...
print('Ubuntu 20.04 compatibility test passed')
"

# Check that conda was installed properly
check "Conda environment works on Ubuntu 20.04" conda env list | grep -q "fenicsx-env"
